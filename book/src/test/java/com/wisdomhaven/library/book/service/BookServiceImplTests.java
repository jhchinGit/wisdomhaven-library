...
import com.wisdomhaven.library.book.service.impl.BookService;
...
class BookServiceImplTests {
    ...
    void givenBookId_whenGetBooks_thenReturnBookResponseDTOPage() {
        ...
        String isbn = "1";
        Book book = Book.builder().bookId(bookId).title(title).author(author).isbn(isbn).isAvailable(true).build();
